        ...
        headers: [
          // Content-Security-Policy — restrict script/style/connect sources
          {
            ...
            value: [
              ...
              "connect-src 'self' https://eth.api.pocket.network https://base.api.pocket.network https://solana.api.pocket.network https://arb1.arbitrum.io https://rpc.ankr.com https://api.wormholescan.io https://*.walletconnect.com wss://*.walletconnect.com https://*.coinbase.com",
